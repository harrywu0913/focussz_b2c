...
<html>
<head>
<%-- <%@ include file="/view/base/common_html_meat.jsp"%> --%>
<%-- <%@ include file="/view/base/common_css.jsp"%> --%>
<style>
	#advert img{
		max-width: 300px;
		max-height: 477px;
						  ...
						  <div class="panel-body">
						    ...
						    <div>
								<a href="<%=request.getContextPath() %>/user/qqLogin.html" title="使用QQ号登陆">
			              		<img src="/resource/images/qqLogin.png">
			              	</a>
							</div>
			              	<br>
			              	...
			              	<div>
				              	<a  href="<%=request.getContextPath() %>/user/sinawb.html" title="使用新浪微博账号登陆">
				              		<img src="/resource/images/sinawbLogin.png">
				              	</a>
			              	</div>
			              	<br>
			              	...
			              	<div>
				              	<a href="alipayFastLogin.html" title="使用支付宝快捷登陆">
									<img src="/resource/images/alipay_fastlogin.jpg" alt="支付宝快捷登陆">
								</a>
			              	</div>
							<br>
				...
				<s:form role="form" id="form" cssClass="form-horizontal" action="/user/doRegister.html" theme="simple" >   
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-md-6" style="float: right;">
				    	<img src="/ValidateImage.do" id="codes2" 
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-md-6">
				    	<a target="_blank" class="form-control" href="/help/zcxy.html">《用户注册协议》</a>
				    </div>
				  </div>
...
<%-- function reloadImg2() {
	document.getElementById("codes2").src = "/ValidateImage.do?" + "radom="
			+ Math.random();
	$("#vcode2").focus();
} --%>
</script>
